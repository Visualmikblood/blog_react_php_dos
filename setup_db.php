<?php
// Script para configurar la base de datos sin datos de ejemplo largos
...
try {
    ...
    $insertSql = "
    INSERT IGNORE INTO users (name, email, password, role, bio) VALUES
    ...
    $db->exec($insertSql);
    echo "✅ Datos básicos insertados exitosamente\n";

    echo "🎉 Base de datos configurada correctamente. Ahora puedes crear tus propios artículos.\n";
