...
import {
  ...
  Home, BookOpen, Clock, ArrowLeft, Moon, Sun, Heart, Menu
} from 'lucide-react';
...
const AdminPanel = () => {
  ...
  const Dashboard = () => (
    <div className="space-y-6">
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        <div className="bg-white dark:bg-gray-800 p-4 md:p-6 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700">
          <div className="flex items-center">
            ...
            <div className="ml-3 md:ml-4">
              <h3 className="text-lg md:text-2xl font-bold text-gray-800 dark:text-gray-200">{posts.length}</h3>
              <p className="text-xs md:text-sm text-gray-600 dark:text-gray-400">Total Artículos</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-4 md:p-6 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700">
          <div className="flex items-center">
            <div className="p-2 md:p-3 bg-green-100 dark:bg-green-900/20 rounded-lg">
              <Eye className="w-5 h-5 md:w-6 md:h-6 text-green-600 dark:text-green-400" />
            </div>
            <div className="ml-3 md:ml-4">
              <h3 className="text-lg md:text-2xl font-bold text-gray-800 dark:text-gray-200">{posts.reduce((total, post) => total + (post.views || 0), 0)}</h3>
              <p className="text-xs md:text-sm text-gray-600 dark:text-gray-400">Vistas Totales</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-4 md:p-6 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700">
          <div className="flex items-center">
            <div className="p-2 md:p-3 bg-purple-100 dark:bg-purple-900/20 rounded-lg">
              <MessageSquare className="w-5 h-5 md:w-6 md:h-6 text-purple-600 dark:text-purple-400" />
            </div>
            <div className="ml-3 md:ml-4">
              <h3 className="text-lg md:text-2xl font-bold text-gray-800 dark:text-gray-200">{posts.reduce((total, post) => total + (post.comments || 0), 0)}</h3>
              <p className="text-xs md:text-sm text-gray-600 dark:text-gray-400">Comentarios</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-4 md:p-6 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700">
          <div className="flex items-center">
            <div className="p-2 md:p-3 bg-orange-100 dark:bg-orange-900/20 rounded-lg">
              <Folder className="w-5 h-5 md:w-6 md:h-6 text-orange-600 dark:text-orange-400" />
            </div>
            <div className="ml-3 md:ml-4">
              <h3 className="text-lg md:text-2xl font-bold text-gray-800 dark:text-gray-200">{categories.length}</h3>
              <p className="text-xs md:text-sm text-gray-600 dark:text-gray-400">Categorías</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="p-4 md:p-6">
          <div className="flex flex-col lg:flex-row items-stretch lg:items-center gap-4 mb-6">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-4 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 flex-1 sm:flex-none"
              >
                Limpiar
              </button>
            </div>
                ...
                <tr className="border-b border-gray-200 dark:border-gray-600">
                  <th className="w-12 py-3 px-4 text-gray-800 dark:text-gray-200">
                    <div className="flex items-center">
                      ...
                      />
                      <span className="ml-2 text-sm font-medium">Todos</span>
                    </div>
                  </th>
          ...
          <div className="md:hidden space-y-4">
            {(filteredPosts.length > 0 ? filteredPosts : posts).map((post, index) => (
              <div
                key={post.id}
                className={`bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-600 p-4 ${
                  selectedPosts.includes(post.id) ? 'bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-800' : ''
                }`}
              >
                <div className="flex items-start gap-3">
                  <input
                    ...
                    checked={selectedPosts.includes(post.id)}
                    onChange={() => handleSelectPost(post.id)}
                    className="h-5 w-5 text-blue-600 focus:ring-blue-500 focus:ring-2 border-2 border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 hover:border-blue-400 dark:hover:border-blue-500 transition-all cursor-pointer checked:bg-blue-600 checked:border-blue-600 mt-1"
                  />
                  <div className="flex-1 min-w-0">
                    ...
                    <h4 className="font-medium text-gray-800 dark:text-gray-200 mb-1">{post.title}</h4>
  ...
  const Sidebar = () => {
    ...
    const handleMenuClick = (viewId) => {
      ...
      setIsMobileMenuOpen(false); // Cerrar menú móvil al seleccionar opción
    };
    ...
    return (
      <>
        ...
        {/* Sidebar */}
        <div className={`
          fixed md:static inset-y-0 left-0 z-50 w-64 bg-white dark:bg-gray-800 shadow-lg transform transition-transform duration-300 ease-in-out
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        <header className="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700">
          <div className="max-w-6xl mx-auto px-4 md:px-6 py-4 md:py-6">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2 md:gap-4 ml-4">
                ...
                <button
                  ...
                  className="px-3 md:px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg hover:shadow-lg transition-all duration-300 dark:from-blue-600 dark:to-purple-700 text-sm md:text-base"
                >
                  Panel Admin
                </button>
              </div>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 mt-4 md:mt-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
              {publicPosts.map(post => (
                ...
                >
                  ...
                  <div className="p-4 md:p-6 flex-1 flex flex-col justify-end">
                    ...
                    <h2 className="text-lg md:text-xl font-bold text-gray-900 dark:text-white mb-3 line-clamp-2">
                      {post.title}
                    </h2>
                    ...
                    <div className="flex items-center justify-between text-sm text-gray-500 dark:text-gray-400">
                      ...
                      <span className="text-xs text-gray-400 dark:text-white hidden sm:block">
                    ...
                    <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-100">
                      ...
                      <span
                        className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 font-medium cursor-pointer text-sm md:text-base"
                        onClick={(e) => {
                          e.stopPropagation();
                          viewPost(post.id);
                        }}
